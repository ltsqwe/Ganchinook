...
namespace Chinook.Data
{
    public class DataRepository
    {
        ...
        {
#if DEBUG
            string connectionString = "metadata=res://*/Chinook.csdl|res://*/Chinook.ssdl|res://*/Chinook.msl;provider=System.Data.SqlClient;provider connection string=\"data source=10.10.14.72;initial catalog=Chinook;persist security info=True;user id=sa;password=3512;MultipleActiveResultSets=True;App=EntityFramework\"";
#else
